          ...
          >
            ...
            >
              ...
              >
                <img
                  ...
                  style={{ border: '1px solid #E9EAEB', flexShrink: 0 }}
                />
                <span
                  style={{
                    fontWeight: 600,
            ...
            >
              <span
                style={{
                  background:
                    tierColorMap[selectedOrg?.tier]?.backgroundColor ||
                    '#FFF1F3',
                  width: '100%',
              ...
              >
                {selectedOrg?.tier?.charAt(0)?.toUpperCase() +
                  selectedOrg?.tier?.slice(1) || ''}
              </span>
            </div>
          </div>
        )}
              ...
              >
                ...
                <span
                  ...
                  style={{
                    ...
                    backgroundColor:
                      tierColorMap[org.tier]?.backgroundColor || '#FFF1F3',
                    color: tierColorMap[org.tier]?.color || '#C01048',
                    border:
                      tierColorMap[org.tier]?.border || '1px solid #E9EAEB',
                    borderRadius: 8,
                    padding: '2px 10px',
                    fontSize: 14,
                    fontWeight: 500,
